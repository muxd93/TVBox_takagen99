...
public class Checker {
    ...
    public void checkProxy(OnProxyAvailableListener onProxyAvailableListener) {
        ...
        OkGo.<String>get(Constants.DOMAIN_NAME_PROXY)
                .client(mClient)
    ...
    public void getAllProxyUrls(OnCheckProxyUrlsListener listener) {
        ...
        LogUtil.i("从sd卡的urls.txt获取带分隔符的链接字符串");
        ...
        OkGo.<String>get("http://127.0.0.1:9978/file/urls.txt")
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        LogUtil.i("代理链接：" + Arrays.toString(urls));
                        for (String url : urls) {
                    ...
                    public void onError(Response<String> response) {
                        super.onError(response);
                        // LogUtil.i("urls.txt不存在使用默认代理链接: " + URL.DOMAIN_NAME_PROXY);
                    }
