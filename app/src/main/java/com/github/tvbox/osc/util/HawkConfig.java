...
public class HawkConfig {
    ...
    public static final String MULTI_API_NAME = "api_name_history";
    ...
    // Multi API
    public static final String MULTI_API_URL = "multi-api_list";
    public static final String MULTI_API_MAP = "api_map";
    public static final String STORE_API_URL = "store_api_url";
    ...
    public static final String HOME_SHOW_SOURCE = "show_source";         // 数据源显示
    ...
    public static final String SET_AS_LAUNCHER = "set_as_launcher";
    public static final String AUTO_CHANGE_SOURCE = "auto_change_source";

    // Live Settings
    public static final String LIVE_LOCAL_CHANNEL = "live_local_channel";
    ...
    public static final String LIVE_SCALE = "live_scale";
    public static final String LIVE_EPG_CACHE = "live_epg_cache";
